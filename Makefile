...
REFLOC = ~/Documents/Latex_art_beamer/ref
PACKAGE=thuthesis
SOURCES=$(PACKAGE).ins $(PACKAGE).dtx
THESISCONTENTS=$(THESISMAIN).tex data/*.tex $(FIGURES)
# NOTE: update this to reflect your local file types.
#FIGURES=$(wildcard figures/*.eps figures/*.pdf)
FIGURES=$(wildcard ~/Documents/Latex_art_beamer/Figures/*.eps ~/Documents/Latex_art_beamer/Figures/*.pdf)
#BIBFILE=ref/*.bib
BIBFILE=$(REFLOC)/*.bib
